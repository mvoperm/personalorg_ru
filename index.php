...
<body>
	...
	<article class='item'>
		...
		<p class='multipar-text'>Доработаны стили представления информации, в основном касающиеся удобства работы на небольших сенсорных экранах мобильных устройств. Сейчас сервисом можно вполне комфортно пользоваться на устройстве с шириной экрана в портретной ориентации 360 px.</p>
