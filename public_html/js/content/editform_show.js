import {getInputValueFromId, setInputValueFromId, checkElement, checkElementById, setMaxElementsQuantity} from './general.js';
import {Editform} from './construct_Editform.js';

/* ФОРМА РЕДАКТИРОВАНИЯ КОНТЕНТА - отображение формы */
