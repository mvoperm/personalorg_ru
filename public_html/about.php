...
<head>
	...
	<link id='no-js-css' rel='stylesheet' href='/css/no-pack/no-js.css'><!-- Стиль для страницы без JavaScript -->
</head>
		...
		<section id='items'>
			...
			<section class='itemsfolder' data-folder-idtotal='1'>
				...
				<article data-folder-idtotal='1' data-idlocal='2' class='item'>
					...
					<p>Для работы сервиса необходимо включение языка программирования JavaScript с поддержкой модулей (ECMAScript 2017 или ES8).</p>
