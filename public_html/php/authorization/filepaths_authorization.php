...
define('CREATE_USER_DIR_FILEPATH', PHP_FOLDER . '/authorization/create_user_dir.php'); // Авторизационные данные. !!! Для публичных репозиториев данного кода вместо файла pw.php помещается файл pw_pseudo.php, где реальные пароли и наименования заменены на их псевдозначения
