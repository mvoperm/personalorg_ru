...
/*
define('RELOCATION_DESTINATION_FOLDER', ($_POST['relocation_type'] == 'in_folder' && $_POST['element_toedit_type'] == 'item') ? $_POST['folder_id'] : $_POST['relocation_destination_folder']);
*/
